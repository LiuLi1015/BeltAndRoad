...
var timer = setInterval(function() {
    ...
    var chartContainer = document.querySelector('.bar');
    var chart = document.querySelector('.bar .chart');
    var isPopupVisible = false;

    document.querySelector('.bar h2').addEventListener('click', function() {
        if (!isPopupVisible) {
  ...
  (function () {
    ...
    popup.style.width='870px';
    popup.style.height='620px';
    var chartContainer = document.querySelector('.bar2');
    var chart = document.querySelector('.bar2 .chart');
    var isPopupVisible = false;

    document.querySelector('.bar2 h2').addEventListener('click', function() {
        if (!isPopupVisible) {
            popup.style.display = 'block';
            popup.style.position = 'fixed';
            popup.style.top = '50%';
